		<?php get_header(); ?>
			...
			<div class="category-listing-intro">
				...
				<?php elseif (is_category('A Day in the Life')) : ?>
					...
					<p>I was really excited when Manda started this linkup because I used to do a photography ‘A Day in the Life’ on my photoblog, which was organised by Tracey of sh1ft.org/chasethelight.org. </p>
				...
				<?php elseif (is_category('Fashion')) : ?>
					<p><strong>Fashion</strong> contains posts about fashion. There may be general posts about fashion trends, or photos of some clothing or accessories that I own. More recently, most photos of outfits and accessories will be in <a href="/category/fashion-friday">Fashion Friday</a>.</p>
