		...
		<?php if (have_posts()) : ?>
				...
				<p>Your search for <mark class="search-highlight"><?php echo wp_specialchars($s); ?></mark> returned the following results. Results are displayed newest first, only showing a 90-word-maximum formatting-limited summary of the beginning of the post or page. Instances of your search term are <mark class="search-highlight">highlighted</mark>.</p>
			<?php while (have_posts()) : the_post(); ?>
				...
				<article class="post">
					...
					<div class="post-content">
						<?php search_excerpt_highlight(90); ?>
						<p>
							<a class="btn more-link" href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Continue reading &raquo;</a>
						</p>
					</div>
				</article>
			<?php endwhile; ?>
