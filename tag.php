<?php get_header(); ?>
	<section class="post-listing post-listing--category">
		<div class="post-listing__intro">
			<h1 class="post__title">Tag: <?php single_cat_title(); ?></h1>
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		<article class="post" itemscope itemtype="http://schema.org/BlogPosting" role="article">
			...
			<div class="post__content" itemprop="text">
				<?php short_excerpt(80); ?>
				<p class="post__cta-container">
					<a href="<?php the_permalink() ?>" title="Permanent Link to <?php the_title(); ?>" itemprop="url" class="post__cta">Read post &raquo;</a>
				</p>
			</div>
		</article>
	<?php endwhile; ?>
	</section>
	<nav class="pagination pagination--home" role="navigation" aria-label="Tag archive">
